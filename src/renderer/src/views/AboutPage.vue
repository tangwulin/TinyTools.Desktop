  ...
  <div class="flex flex-col items-center h-full">
    ...
    <div class="flex flex-row" style="max-height: 100px">
      <a href="https://vitejs.cn/" target="_blank">
        <img src="https://vitejs.cn/vite3-cn/logo.svg" alt="vite logo" class="h-16" />
      </a>
    ...
    <div class="flex flex-row" style="max-height: 100px">
      <a href="https://github.com/tangwulin/TinyTools/" target="_blank">
        <svg class="h-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          <path
    ...
    <div class="mt-auto text-xs">
      <p class="mt-auto flex">
        ...
        <a class="ml-auto" :href="githubLink" target="_blank"> #{{ revision }} </a>
        &nbsp;{{ buildDate }}
      </p>
