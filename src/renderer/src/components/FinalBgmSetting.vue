...
onMounted(() => {
  tableHeight.value = document.getElementById('bgmSettingContainer').clientHeight - 1
})

window.addEventListener('resize', debounce(() => {tableHeight.value = document.getElementById('bgmSettingContainer').clientHeight - 1}, 200))
